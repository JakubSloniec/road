...
public class Waypoint extends Extension {
     ...
     *
     * @param dGpsStationId an Integer representing the dGpsStationId of this waypoint.
     */
     ...
     *
     * @param fix a {@link Fix} representing the fix of this waypoint.
     */
     ...
     * &lt;magvar&gt; tag value.
     *
     * @param magVar A String representing the magnetic declination of this
     *               waypoint.
     */
...
//	}
    ...
    @Override
    public String toString() {
        return "Waypoint{" + latitude + "," + longitude + "," + time + "}";
    }
}
